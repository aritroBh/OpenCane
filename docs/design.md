...
| Cloud turn still thinking (1.5 s, 3 s) | `thinking` A6 20 ms, −28 dBFS | — (was "One moment.") |
| Cloud timeout (4 s) or failure | `error` B♭3 55 ms, G3 65 ms, −16 dBFS | "No answer." (was "That is taking too long. Ask again in a moment.") |
