...
| **What's left to do** | [`todo.md`](todo.md). The latest `CHANGELOG.md` entry (Step 25) lists the camera-interlock device checks; older step entries retain their historical test notes. |
