...
/// The hop rate `DepthEngine`'s anchor relay throttles to: the depth pipeline publishes at 15 Hz
/// and the beacon renders at 10 Hz, so hopping faster is main-thread work nobody reads.
