...
final class AppModel {
    ...
    var dangerSoundsEnabled: Bool = Settings.bool("dangerSoundsEnabled", default: false) {
        didSet {
            Settings.set(dangerSoundsEnabled, "dangerSoundsEnabled")
    ...
    private func setBothCameras(_ on: Bool) {
        ...
        if on {
            ...
            serializeBothCameras { [weak self] in
                ...
                if let error = self.bothCameras.lastError {
            ...
            serializeBothCameras { [weak self] in
                ...
                self.speech.say("Both cameras off. Obstacle detection is back.", .nav, ttl: 10)
