...
**Status.** Steps 0–11 have landed and are verified on the simulator: 124 logic tests, 7
...
| `make test` | `scripts/test.sh`: the 124 `CaneKitLogic` tests (Swift Testing). Works with the Command Line Tools alone. |
...
- **Unit tests (`Logic/`, no device):** 124 Swift Testing tests. They cover lane extraction on
