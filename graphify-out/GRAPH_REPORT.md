...
## Corpus Check
- 111 files · ~199,306 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1880 nodes · 4060 edges · 110 communities (100 shown, 10 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 422 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63305b12`
...
Cohesion: 0.12
Nodes (18): AppModel, .extendedRange, .hapticsEnabled, .mirrorLeftRight, .portraitMode, .speechEnabled, .urgentDistance, .warnDistance (+10 more)

### Community 1 - "Foundation"
Cohesion: 0.20
Nodes (6): AVFoundation, CaneKitLogic, CoreBluetooth, CoreHaptics, Foundation, Observation
...
### Community 10 - ".mapKit"
Cohesion: 0.15
Nodes (10): CLLocation, destinationNotFound, RouteSource, RouteBuilder, RouteStepInput, Data, mapKitStepsBecomeWaypoints(), routeFileDecodesSnakeCaseSchema() (+2 more)
...
Cohesion: 0.22
Nodes (11): .statusHeader, LaneCell, .background, .body, LaneFormat, LaneGrid, .body, Bool (+3 more)

### Community 29 - "String"
Cohesion: 0.17
Nodes (13): Settings, String, .sentenceCased, OnDeviceHazards, OnDeviceVision, OnDeviceVLMClient, SceneContext, Bool (+5 more)
...
Cohesion: 0.18
Nodes (15): C, Equatable, CourseSmoother, Double, Int, TimeInterval, GeoFix, SeenText (+7 more)
...
Cohesion: 0.18
Nodes (7): ARKit, CoreImage, CoreMotion, CoreVideo, ImageIO, simd, UIKit

### Community 47 - "Float"
Cohesion: 0.29
Nodes (3): Config, GroundSample, Float

### Community 48 - "SwiftUI"
Cohesion: 0.14
Nodes (10): App, CaneKitApp, .body, Scene, Scene, WatchApp, .body, WatchContentView (+2 more)
...
### Community 50 - "Text"
Cohesion: 0.14
Nodes (16): HapticsCard, .body, .cueWord, HazardsCard, .body, CKStatusPill, .body, .fill (+8 more)
...
Cohesion: 0.33
Nodes (4): FoundationModels, normalize(), Synchronization, Vision
...
Cohesion: 0.15
Nodes (14): RouteError, .errorDescription, missingBundledRoute, noRoute, DescribeError, badResponse, .errorDescription, http (+6 more)
...
Cohesion: 0.29
Nodes (8): Frame, FrameReplay, .currentName, State, Bool, Data, URL, Sendable
...
### Community 73 - "Double"
Cohesion: 0.32
Nodes (5): .current, GeoMath, Double, wrapping(), bearingConsistencyCheckCatchesTypos()
...
### Community 75 - "RouteSource.swift"
Cohesion: 0.29
...
Cohesion: 0.21
Nodes (8): HazardWatchPolicy, Double, Set, TimeInterval, aLateReplyLosesItsDistance(), hazardReplyKeepsDecimals(), hazardWatchAsksOnlyWhileWalkingAndRarely(), hazardWatchRepliesBecomeShortCautions()
...
### Community 90 - ".distanceMeters"
Cohesion: 0.19
Nodes (5): NavEvent, reached, Bool, Int, isrToCifIsAboutSevenHundredMetres()
...
### Community 101 - "Module `depth-haptics` — `ios/CaneKit/Depth/*.swift`, `ios/CaneKit/Haptics/HapticPlayer.swift`"
Cohesion: 0.29
...
### Community 107 - "`ios/CaneKit/Speech/SpeechQueue.swift`"
Cohesion: 0.40
...
## Knowledge Gaps
- **451 isolated node(s):** `AppIntents`, `.localizedStringResource`, `.status`, `.hapticsSilenced`, `.loggingEnabled` (+446 more)
...
- **Why does `String` connect `String` to `AppModel`, `Foundation`, `CaneKitUITests`, `DepthEngine`, `NavSupportTests.swift`, `BeaconEngine`, `CaneBLE`, `HapticPlayer`, `.mapKit`, `CKBigButtonStyle`, `VLMClient`, `LaneTile`, `NavigationEngine`, `VLMError`, `RuntimeRelay`, `ObstacleClass`, `AppModel`, `WKBigButton`, `NavLiveActivity`, `WatchModel`, `SpeechQueue`, `sign_probe.swift`, `LaneCell`, `Decodable`, `PhoneToWatch`, `Equatable`, `HazardScanner`, `LiveActivityController`, `TripLogger`, `ElevenLabsVoice`, `SceneVocabularyTests.swift`, `TripTracker`, `.wireNavigation`, `Float`, `Text`, `PhoneWatchLink`, `GuideCard`, `.say`, `CodingKeys`, `OnDeviceVision.swift`, `GroundHazard`, `.groundHazardFound`, `HazardRecord`, `DescribeError`, `NSObject`, `SessionObserver`, `Sendable`, `Codable`, `SignPolicy`, `Double`, `.handle`, `View`, `SceneDescriber`, `HazardWatchPolicy`, `VLMProvider`, `WorkoutRelay`, `Waypoint`, `NavCue`?**
  _High betweenness centrality (0.459) - this node is a cross-community bridge._
- **Why does `AppModel` connect `AppModel` to `Foundation`, `NavSupportTests.swift`, `BeaconEngine`, `HapticPlayer`, `docs/README.md`, `NavigationEngine`, `ObstacleClass`, `SpeechQueue`, `DepthEngine`, `String`, `HazardScanner`, `LiveActivityController`, `TripLogger`, `TripTracker`, `.wireNavigation`, `SwiftUI`, `PhoneWatchLink`, `.say`, `.groundHazardFound`, `HazardRecord`, `NSObject`, `SignPolicy`, `.handle`?**
