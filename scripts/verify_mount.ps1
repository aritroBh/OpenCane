...
.DESCRIPTION
    ...
    What it proves, in order:
      ...
      3. The thread works as a mechanism: the ring lifted 0.75 / 2.25 mm
         ...
         only meets the collar's cone in the last collet_squeeze/taper mm;
         axial slack is thr_axial/2 per flank.
      4. The ring is the collar joint's lock: the arm lifted 0.4 mm is free
         (that is its gap), lifted 1 mm it hits the ring.
      5. Every printable is one solid shell, and the print-orientation
         overhang report for the arm and the cradle looks as documented.
